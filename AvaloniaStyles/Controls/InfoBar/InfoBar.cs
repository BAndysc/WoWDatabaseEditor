...
{    
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        if (_closeButton != null)
        {
            ...
            ToolTip.SetTip(_closeButton, "Close");//FALocalizationHelper.Instance.GetLocalizedStringResource(SR_InfoBarCloseButtonTooltip));
        }
    ...
    {
        PseudoClasses.Set(s_pcForegroundSet, this.GetValue(TextBlock.ForegroundProperty) != AvaloniaProperty.UnsetValue);
    }
