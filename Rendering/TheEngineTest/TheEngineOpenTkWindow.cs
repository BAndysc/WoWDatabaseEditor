...
public class TheEngineOpenTkWindow : GameWindow, IWindowHost
{
    ...
    private void UpdateMouse()
    {
        ...
        {
            engine.inputManager.mouse.MouseDown(TheEngine.Input.MouseButton.Left);
            pendingLeftMouseDown = false;
        }
        else if (pendingLeftMouseUp)
        {
            engine.inputManager.mouse.MouseUp(isRightDown ? TheEngine.Input.MouseButton.Right : TheEngine.Input.MouseButton.None);
            pendingLeftMouseUp = false;
        }

        if (pendingRightMouseDown)
        {
            engine.inputManager.mouse.MouseDown(TheEngine.Input.MouseButton.Right);
            pendingRightMouseDown = false;
        }
        else if (pendingRightMouseUp)
        {
            engine.inputManager.mouse.MouseUp(isLeftDown ? TheEngine.Input.MouseButton.Left : TheEngine.Input.MouseButton.None);
