...
{
    [AutoRegister]
    public class CreatureTemplateTableProvider : DatabaseTableSolutionItemProvider
    {
        private readonly IDatabaseTableDataProvider tableDataProvider;
        private readonly ICreatureEntryProviderService creatureEntryProviderService;

        public CreatureTemplateTableProvider(IDatabaseTableDataProvider tableDataProvider, ICreatureEntryProviderService creatureEntryProviderService) : 
        ...
        public override async Task<ISolutionItem?> CreateSolutionItem()
        {
            ...
            if (key.HasValue)
            {
                ...
                if (data != null)
                    return new DatabaseTableSolutionItem(key.Value, "creature_template");
            }
