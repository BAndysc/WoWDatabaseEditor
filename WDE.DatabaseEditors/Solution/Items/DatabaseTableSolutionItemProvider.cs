...
{
    public abstract class DatabaseTableSolutionItemProvider : ISolutionItemProvider
    {
        private readonly string itemName;
        private readonly string itemDescription;
        private readonly ImageUri itemIcon;

        protected DatabaseTableSolutionItemProvider(string itemName, string itemDescription, string itemIconName)
        {
