...
namespace WDE.MapRenderer.Utils
{
    public class Gizmo
    {
        ...
        public HitType HitTest(IGameContext context, out Vector3 intersectionPoint)
        {
            ...
            t.Rotation = PlaneX;
            if (Physics.RayIntersectsObject(dragPlaneMesh, t.LocalToWorldMatrix, ray, out intersectionPoint))
            ...
            t.Rotation = ArrowX;
            if (Physics.RayIntersectsObject(arrowMesh, t.LocalToWorldMatrix, ray, out intersectionPoint))
