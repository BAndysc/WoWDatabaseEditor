...
namespace WDE.CMMySqlDatabase.Models
{
    public abstract class BaseDatabaseTables : DataConnection
    {
        ...
        public ITable<SpawnGroupEntry> SpawnGroupRandomEntries => this.GetTable<SpawnGroupEntry>();
        public ITable<SpawnGroupLinkedGroup> SpawnGroupLinkedGroups => this.GetTable<SpawnGroupLinkedGroup>();
        public ITable<SpawnGroupSquad> SpawnGroupSquads => this.GetTable<SpawnGroupSquad>();
        public ITable<PoolTemplate> PoolTemplate => this.GetTable<PoolTemplate>();
        public ITable<PoolCreature> PoolCreatures => this.GetTable<PoolCreature>();
        public ITable<PoolGameObject> PoolGameObjects => this.GetTable<PoolGameObject>();
        public ITable<PoolCreatureTemplate> PoolCreatureTemplates => this.GetTable<PoolCreatureTemplate>();
        public ITable<PoolGameObjectTemplate> PoolGameObjectTemplates => this.GetTable<PoolGameObjectTemplate>();
        public ITable<PoolPool> PoolNestings => this.GetTable<PoolPool>();
        public ITable<CreatureLinking> CreatureLinkings => this.GetTable<CreatureLinking>();
        public ITable<CreatureLinkingTemplate> CreatureLinkingTemplates => this.GetTable<CreatureLinkingTemplate>();
