...
public class DatabaseProviderClassic : BaseDatabaseProvider<ClassicDatabase>
{
    ...
    protected override Task<IGameObject?> GetGameObjectByGuidAsync(ClassicDatabase model, uint guid)
    {
