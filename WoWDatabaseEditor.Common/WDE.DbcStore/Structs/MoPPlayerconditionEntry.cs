...
public class MoPPlayerconditionEntry : IPlayerCondition
{
    ...
    public int AuraStacksCount { get; set; }
    ...
    public byte GetAuraStacks(int index) => throw new Exception("not used on mop");
    ...
    public int QuestKillMonsterCount => 4;
    ...
    public int MovementFlagsCount => 0;
    public int GetMovementFlags(int index) => throw new Exception("not used on mop");
