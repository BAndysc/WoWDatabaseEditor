...
namespace WDBXEditor.Common
{
    public static class Constants
    {
        ...
        public static readonly string DefinitionDir = "Definitions/";

        public static readonly string TempFolder =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "WDBXEditor");

        public static readonly string OffsetMapPath = Path.Combine(DefinitionDir, "Offsets.json");
        ...
        public static string BuildText(int build)
        {
            ...
            var lastText = $"{first.Value} ({build})";
        ...
        public static List<string> ClientDBFileNames { get; private set; } = new()
        {
        ...
        private static async Task LoadListFile()
        {
            ...
            ClientDBFileNames = File.ReadAllLines(listfile)
                .AsParallel()
