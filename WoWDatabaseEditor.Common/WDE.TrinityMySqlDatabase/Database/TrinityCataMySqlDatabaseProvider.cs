...
public class TrinityCataMySqlDatabaseProvider : BaseTrinityMySqlDatabaseProvider<TrinityCataDatabase>
{
    ...
    public override async Task<List<IEventScriptLine>> FindEventScriptLinesBy(
    ...
    public override async Task<IList<ISmartScriptLine>> GetScriptForAsync(uint entry, int entryOrGuid,
    ...
    public override async Task<IList<ISmartScriptLine>> FindSmartScriptLinesBy(
