...
namespace WDE.DbScriptsEditor.Models
{
    ...
    public static class DbScriptBuddyLeaves
    {
        ...
        public static readonly IReadOnlyList<DbScriptBuddyLeaf> All = new[]
        {
            ...
            new DbScriptBuddyLeaf("stringid_closest_dead", "Closest object by string id (incl. dead)", StringId,
                "The closest object tagged with a string id; dead/despawned creatures allowed.",
            ...
            new DbScriptBuddyLeaf("stringid_all_alive", "All objects by string id (alive)", StringId,
                ...
                LeafPrompt.StringId, LeafPrompt.OptionalRadiusYd),
            new DbScriptBuddyLeaf("stringid_all_dead", "All objects by string id (incl. dead)", StringId,
                "Every object tagged with a string id; dead/despawned creatures allowed.",
