...
namespace WDE.MySqlDatabaseCommon.Database.World
{
    public class WorldDatabaseDecorator : IDatabaseProvider
    {
        ...
        public Task<List<IBroadcastText>> GetBroadcastTextsAsync() => impl.GetBroadcastTextsAsync();
        ...
        public Task<IList<IDatabaseSpellEffectDbc>> GetSpellEffectDbcAsync() => impl.GetSpellEffectDbcAsync();
