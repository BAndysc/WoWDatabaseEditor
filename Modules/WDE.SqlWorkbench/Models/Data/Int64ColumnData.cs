...
internal class Int64ColumnData : IColumnData
{
    ...
    public void Append(IMySqlDataReader reader, int ordinal)
    {
        ...
        nulls[index] = false;
        data[index] = reader.GetInt64(ordinal);
    }
    ...
    public bool TryOverride(int rowIndex, string? str, out string? error)
    {
        ...
        error = "Invalid long value (allowed range: -9223372036854775808 - 9223372036854775807)";
        return false;
    }
    
    public IColumnData CloneEmpty() => new Int64ColumnData();
}