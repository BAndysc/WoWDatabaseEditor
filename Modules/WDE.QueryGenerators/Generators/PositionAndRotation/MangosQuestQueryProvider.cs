...
public class MangosPositionAndRotationQueryProvider : IUpdateQueryProvider<PositionAndRotationDiff>
{
    private readonly IDatabaseProvider databaseProvider;

    public MangosPositionAndRotationQueryProvider(IDatabaseProvider databaseProvider)
    {
