...
public partial class QuestChainDocumentViewModel : ObservableBase, ISolutionItemDocument, IProblemSourceDocument
{
        ...
        GraphLayoutSettingsViewModel layoutSettingsViewModel)
    {
        ...
        Save = new AsyncAutoCommand(async () =>
        {
            ...
            var newConditions = Elements.OfType<QuestViewModel>().Where(c => c.HasConditions)
    ...
    public async Task<QuestViewModel> LoadQuestWithDependencies(uint quest, Point targetLocation)
    {
        ...
        try
        {
            ...
            ReLayoutGraph(addedQuests, addedConnections);
    ...
    private async Task<QuestStore> BuildCurrentQuestStore()
    {
        RefreshProblems();
